...
class ColorDialog(Gtk.Dialog):
    ...
    def __init__(self, parent, current_file, gcolor):
        ...
        self.sat_slider = Gtk.Scale(
            orientation=Gtk.Orientation.HORIZONTAL, adjustment=sat_range
        )
        ...
        self.light_slider = Gtk.Scale(
            orientation=Gtk.Orientation.HORIZONTAL, adjustment=light_range
        )
        self.light_slider.set_value(light)
        self.light_slider.connect("value-changed", self.slider_changed, "light")
